  ...
  case SCREEN_SELECT :
    {
      if (!flightSelected)
      {
        ...
        //for time
        guessWhatItsAnotherTemp3 = sortListByTime(calendarDataPoint,false);
        temp3 = createSelections(guessWhatItsAnotherTemp3);
        guessWhatItsAnotherTemp4 = sortListByTime(calendarDataPoint,true);
        temp4 = createSelections(guessWhatItsAnotherTemp4);
        
        //for alphabet order by origin
        guessWhatItsAnotherTemp5.addAll(guessWhatItsAnotherTemp3);
        ...
        guessWhatItsAnotherTemp6.addAll(guessWhatItsAnotherTemp3);
...
//      sort by diverted
     ...
     else if(forOptions.searchQuery == "By Longest Distance")
      {
        showFlightSelections(temp7, guessWhatItsAnotherTemp7);
